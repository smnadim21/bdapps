...
public class Subscription {
   ...
   // private static final String defaultServerAddress = "http://vios.datasysbd.net/";
    ...
    private static final String PREFS_NAME = "sub";
    ...
    private static final String sub_code = "ajdygfkgas";
    ...
    public static boolean setPreference(String key, String value) {
        SharedPreferences settings = BdAppsApplication.getContext().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
